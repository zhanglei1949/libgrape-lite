...
class LiveGraphWrapper {
 public:
  ...
  inline fid_t fnum() { return 1; }

  inline VID_T id_mask() const { return 0; }

  inline int fid_offset() const { return 0; }

  inline const vid_t* GetOuterVerticesGid() const { return NULL; }
